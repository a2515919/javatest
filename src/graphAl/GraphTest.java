...
public class GraphTest {
    public static boolean [] visited1 =new boolean[GraphMatrix.MaxNum];
     ...
     * DFS
     */
    public static void DFS(GraphMatrix graph, int v) {
        int w;
        System.out.println(graph.Vertex[v]);
        visited1[v]=true;
        for (w=0;w<graph.VertexNum;w++){
            if (graph.EdgeWeight[v][w]< GraphMatrix.MaxValue&&visited1[w]==false){
                DFS(graph,w);
            }
        }
